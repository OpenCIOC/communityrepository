...
e=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,g,f,h={"\u0008":"\\b","\t":"\\t","\n":"\\n","\u000c":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},i;if("function"!==typeof JSON.stringify)JSON.stringify=function(d,a,b){var e;f=g="";if("number"===typeof b)for(e=0;e<b;e+=1)f+=" ";else"string"===typeof b&&(f=b);if((i=a)&&"function"!==typeof a&&("object"!==typeof a||"number"!==typeof a.length))throw Error("JSON.stringify");return c("",
{"":d})};if("function"!==typeof JSON.parse)JSON.parse=function(a,b){function c(d,a){var e,g,f=d[a];if(f&&"object"===typeof f)for(e in f)Object.hasOwnProperty.call(f,e)&&(g=c(f,e),void 0!==g?f[e]=g:delete f[e]);return b.call(d,a,f)}var e,a=""+a;d.lastIndex=0;d.test(a)&&(a=a.replace(d,function(d){return"\\u"+("0000"+d.charCodeAt(0).toString(16)).slice(-4)}));if(/^[\],:{}\s]*$/.test(a.replace(/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,"@").replace(/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,
...
function(){b(this).remove()})},k=null,n=null;(function(c){b.isArray(c)?(n=function(d,e){var f=RegExp(b.ui.autocomplete.escapeRegex(string_ci_ai(d.term)));e(b.grep(c,function(b){return f.test(string_ci_ai(b[a.match_prop]||b))}))},k=function(d,e){var f=string_ci_ai(d),g=b.grep(c,function(b){return string_ci_ai(string_ci_ai(b[a.match_prop]||b))===f});if(1===g.length)return e(g[0]),!0;e()}):"string"===typeof c?(n=create_caching_source_fn(b,c,h,a.match_prop),k=function(c,d,e){var f=string_ci_ai(c);if(h.content){var g=
b.grep(h.content,function(b){return string_ci_ai(b[a.match_prop])===f});if(1===g.length){d(g[0]);return}}e||string_ci_ai(h.term||"")===f?d():n({term:f},function(){k(c,d,!0)})}):(n=c,k=a.look_for_fn)})(d);var q=b("#add_"+c).click(function(){var d=f.data("chkid"),e=f.data("display"),h=f[0].value;d&&e&&e==h?(g(d,e),i()):k(f[0].value,function(d){d?(g(d.chkid,d.value),i()):0===b("#"+c+"_error").length&&(b("#"+c+"_new_input_table").before(b('<div class="ui-widget clearfix" style="margin: 0.25em;">                <div class="ui-state-error error-field-wrapper">                 <span class="ui-icon ui-icon-alert error-notice-icon"></span>[MSG]                </div>            </div>'.replace("[MSG]",
b("<div>").text(a.not_found_msg||"Not Found").html())).hide().prop("id",c+"_error")),b("#"+c+"_error").show("slow"))})});f.autocomplete({focus:function(){return!1},source:n,minLength:a.minLength,delay:a.delay,select:function(a,b){f.data({chkid:b.item.chkid,display:b.item.value})}}).keypress(function(a){"13"==a.keyCode&&(a.preventDefault(),f.autocomplete("close"),q.trigger("click"))})}
...
(function(){window.init_search_areas_checklist=function(b,a,c){var d={},e=create_caching_source_fn(b,a,d,"display"),g=b("#community_ParentCommunity"),f=9999,h=b("#alt-area-template").html(),i=b("#alt-area-target"),k=function(a,f,g){var h=string_ci_ai(a);if(d.content){var i=b.grep(d.content,function(a){return string_ci_ai(a[c.match_prop])===h});if(1===i.length){f(i[0]);return}}g||string_ci_ai(d.term||"")===h?f():e({term:h},function(){k(a,f,!0)})};c.source=function(a,b,c){a.parent=g.val();return e(a,
