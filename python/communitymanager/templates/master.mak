...
%if request.user:
<a class="ui-button ui-widget ui-state-default ui-corner-bottom ui-button-text-icon-primary" href="${request.route_url('suggest')}"><span class="ui-icon ui-icon-comment ui-button-icon-primary" aria-hidden="true"></span><span class="ui-button-text">${_('Suggest Change')}</span></a>
%if request.user.Admin or request.user.ManageAreaList:
<a class="ui-button ui-widget ui-state-default ui-corner-bottom ui-button-text-icon-primary" href="${request.route_url('review_suggestions')}"><span class="ui-icon ui-icon-mail-open ui-button-icon-primary" aria-hidden="true"></span><span class="ui-button-text">${_('Suggestions')}</span></a>
%endif
%if request.user.Admin:
<a class="ui-button ui-widget ui-state-default ui-corner-bottom ui-button-text-icon-primary" href="${request.route_url('users')}"><span class="ui-icon ui-icon-contact ui-button-icon-primary" aria-hidden="true"></span><span class="ui-button-text">${_('Manage Users')}</span></a>
%endif
<a class="ui-button ui-widget ui-state-default ui-corner-bottom ui-button-text-icon-primary" href="${request.route_url('account')}"><span class="ui-icon ui-icon-person ui-button-icon-primary" aria-hidden="true"></span><span class="ui-button-text">${_('My Account')}</span></a>
<a class="ui-button ui-widget ui-state-default ui-corner-bottom ui-button-text-icon-primary" href="${request.route_path('logout')}"><span class="ui-icon ui-icon-power ui-button-icon-primary" aria-hidden="true"></span><span class="ui-button-text">${_('Logout')}</span></a>
%else:
