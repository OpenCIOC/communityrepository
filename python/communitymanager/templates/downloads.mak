...
%if files:
<p><a rel="license" href="http://creativecommons.org/licenses/by-sa/4.0/"><img alt="Creative Commons Licence" style="border-width:0" src="https://i.creativecommons.org/l/by-sa/4.0/80x15.png" /></a> ${_('The geography data on this site is licensed under a ')}<a rel="license" href="http://creativecommons.org/licenses/by-sa/4.0/">${_('Creative Commons Attribution-ShareAlike 4.0 International License')}</a>.</p>
<ul id="download-list">
